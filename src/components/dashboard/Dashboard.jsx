          ...
          <div className="row">
            ...
            <div className="col-md-4">
              ...
              <span className="sectionTitle sectionTitleYellow text-uppercase">
                ...
                <p className="sectionHeading text-white">
                  Total coconut
                </p>
              ...
              <div className="sectionContainer">
                <div className="d-flex justify-content-between">
                  ...
                  >
                      <p
                          className={`${
                              araliyaKeleStatus && !isAraliyaKeleBreakdown ? "d-block" : "d-none"
                          }`}
                      >
                        Running
                      </p>
                      <p className={`${isAraliyaKeleBreakdown ? "d-block" : "d-none"}`}>
                        Stopped
                      </p>
                    </span>
                </div>
                ...
                <p className="sectionMainValue text-center">
                  {sdData &&
                      sdData.map(
                          (data) => data.location === "araliya_kele" && data.batchNumber
                      )}
                </p>
                ...
                {breakdowns && breakdowns.length > 0 ? (
                    <ListGroup variant="flush" className="mt-2">
                      {breakdowns?.map((breakdown, index) => (
                          <ListGroup.Item key={index} className='breakdownItemWrapper'>
                            <div className="d-flex justify-content-between">
                            ...
                            <p className='smallText text-white'>{breakdown.breakdownDetails}</p>
